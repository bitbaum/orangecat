    ...
    can: [
      {
        ...
        source: 'bitbaum/loki AGENTS.md — "brief → repository → deployed result → feedback → verified change"',
      },
      {
    ...
    cannot: [
      {
        ...
        source: 'bitbaum/loki AGENTS.md — "Loki builds software. It does not make video, music or prose."',
      },
      {
    ...
    can: [
      {
        ...
        source: 'bitbaum/solon AGENTS.md — "proposals, Bitcoin-signed votes, versioned policies, append-only audit"',
      },
      {
        says: 'change the ceiling on what the Cat may spend platform-wide — the only wire between the two products today',
        source: 'this repo — src/config/solon.ts and src/services/solon/ re-verify the signed decision locally',
      },
    ],
    cannot: [
      {
