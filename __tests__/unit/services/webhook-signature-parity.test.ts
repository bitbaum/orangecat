...
// Deliberately NOT shaped like a real key. A realistic fake (`whsec_` plus 32
// hex characters) is exactly what the CI secret scan exists to catch, and a
// scanner that has to be told "this one is fine" is being trained to look away.
